...
// TODO: Indices are always strored as 32 bit, in some cases 16 bit can be used (less memory)

namespace QuantizedMesh
{
    // Decode the quantized mesg terrain format (see https://github.com/AnalyticalGraphicsInc/quantized-mesh)
    ...
    // The first part of the file is a header with the following format. 
    // Doubles are IEEE 754 64-bit floating-point numbers, 
    // Floats are IEEE 754 32-bit floating-point numbers.
